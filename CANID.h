...
#define CCP_B_GNSS_latitude_udeg 0x055
#define CCP_B_GNSS_longitude_udeg 0x056
#define CCP_B_GNSS_altitude_mm 0x057
#define CCP_B_GNSS_time_ms 0x058

// uint16_t


// float
#define CCP_open_time_s 0x080
#define CCP_open_time_repeat_s 0x081

#define CCP_A_pressure_altitude_m 0x085
#define CCP_A_pressure_hPa 0x086
#define CCP_A_temperature_C 0x087
#define CCP_A_humidity_percent 0x088

#define CCP_voltage_main_V 0x090

#define CCP_voltage_actuator_V 0x092
#define CCP_current_actuator_mA 0x093
